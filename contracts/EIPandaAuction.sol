...
contract EIPandaAuction is ReentrancyGuard, Ownable {
    ...
    function endAuction() external nonReentrant activeAuction {
        ...
        if (currentAuction.highestBid >= RESERVE_PRICE) {
            ...
            eipandas.safeTransferFrom(address(this), currentAuction.highestBidder, currentAuction.tokenId);
            emit AuctionSuccessful(currentAuction.tokenId, currentAuction.highestBidder, currentAuction.highestBid);
        } else {
            // R.I.P.
            eipandas.safeTransferFrom(address(this), address(0x000000000000000000000000000000000000dEaD), currentAuction.tokenId);
